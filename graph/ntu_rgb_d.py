...
# pre_link = [(1, 11), (2, 11), (3, 11), (4, 3), (5, 11), (6, 5), (7, 1), (8, 7), (9, 1), (10, 9)]
...
class Graph:
    ...
    def get_adjacency_matrix(self, labeling_mode=None):
        ...
        if labeling_mode == 'spatial':
            ...
            AA = tools.get_spatial_graph(num_node, self_link, inward, outward)
            weights = tools.compute_weighted_graph(AA, 1.0)
            A = AA * weights
